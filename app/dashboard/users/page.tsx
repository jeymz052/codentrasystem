...
import { Plus, Save, Users, UserCheck, X } from 'lucide-react'
          ...
          <div className="modal" style={{ maxWidth: 720 }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12, marginBottom: 20 }}>
              <div>
                ...
                <h3 style={{ fontSize: 20, fontWeight: 800, color: '#0F172A', letterSpacing: '-0.04em' }}>New team member</h3>
                <p style={{ color: '#64748B', fontSize: 13, marginTop: 4 }}>
                  Add a team member, assign a role, and we’ll email them a password setup link.
                </p>
              </div>
